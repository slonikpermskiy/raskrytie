...
return [
	...
	'attributes' => [
		...
		'name' => 'Организация',
		'login' => 'Логин',
		'categoryname' => 'Наименование отчетности',
		'goverment' => 'Государственный орган',
		'law' => 'Нормативный документ',
		'lawlink' => 'Ссылка на нормативный документ',
		'place' => 'Место публикации',
		'comment' => 'Комментарий',
		'otchetname' => 'Наименование отчета',
		'razdelname' => 'Уточнение (статья, пункт постановления)',
		'reportdays' => 'Срок предоставления',
		'whosend' => 'Кто предоставляет',
		'otchetlink' => 'Ссылка на бланк формы',		
    ],
];
